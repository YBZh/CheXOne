...
attending_editing_json_files = [
    "responses/reader-11.json",
    "responses/reader-12.json",
    "responses/reader-13.json",
    "responses/reader-14.json",
    "responses/reader-15.json",
    "responses/reader-16.json",
]
...
# Likert candidates, with scores mapping as required
LIKERT_CANDIDATE = [
    "Strongly Agree",
    "Agree",
    ...
    for field in FIELD_NAMES:
        ...
        if field == "duration":
            ...
            if durinfo:
                ...
                print(f"  All durations (s): {', '.join(f'{d:.6f}' for d in durinfo['list'])}")
            else:
